...
const LadingPage = () => {
    ...
    useEffect(() => {
        var iframe
        var ifr = document.getElementById("JotFormIFrame-212258613909055");
        if (ifr) {
            var src = ifr.src;
            var iframeParams = [];
        ...
        window.isPermitted = function (originUrl, whitelisted_domains) {
            var url = document.createElement('a'); url.href = originUrl;
            var hostname = url.hostname; var result = false;
    ...
    return (
        <iframe
            id="JotFormIFrame-212258613909055"
            title="Preencha as informações abaixo para receber mais informações"
            onload="window.parent.scrollTo(0,0)"
            allowTransparency="true"
            allowFullScreen="true"
            allow="geolocation; microphone; camera"
            src="https://form.jotform.com/212258613909055"
            frameBorder={0}
